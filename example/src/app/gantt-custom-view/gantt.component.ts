...
export class AppGanttCustomViewExampleComponent implements OnInit {
    ...
    items: GanttItem[] = [
        ...
        { id: '000002', title: 'Task 2', start: 1610536397, end: 1610622797, cellStyle: { backgroundColor: 'rgba(0,255,0,.05)' } },
        ...
        { id: '000007', title: 'Task 7', start: 1639393997, end: 1640862797, cellStyle: { backgroundColor: 'rgba(255,0,0,.05)' } },
