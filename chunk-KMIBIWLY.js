...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxGanttRangeComponent, [{
    type: Component,
    args: [{ selector: "ngx-gantt-range,gantt-range", changeDetection: ChangeDetectionStrategy.Eager, imports: [NgTemplateOutlet], template: '@if (item().start && item().end) {\n  <div class="gantt-range-main">\n    @if (item().progress >= 0) {\n      <div class="gantt-range-main-progress" [style.width.%]="item().progress * 100"></div>\n    }\n  </div>\n  <div class="gantt-range-triangle left"></div>\n  <div class="gantt-range-triangle right"></div>\n  <ng-template [ngTemplateOutlet]="template()" [ngTemplateOutletContext]="{ item: item().origin, refs: item().refs }"></ng-template>\n}\n' }]
  }], () => [], { ganttRangeClass: [{
    type: HostBinding,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NgxGanttRangeComponent, { className: "NgxGanttRangeComponent", filePath: "packages/gantt/src/components/range/range.component.ts", lineNumber: 11 });
})();

export {
  NgxGanttRangeComponent
};
//# debugId=3b44c4b6-5120-5477-844f-1715df5c63f0
//# sourceMappingURL=chunk-KMIBIWLY.js.map
