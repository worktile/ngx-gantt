import {
  ...
  ɵɵviewQuery,
  ɵɵviewQuerySignal
} from "./chunk-3DE4NDGJ.js";
import {
  __spreadProps,
  __spreadValues
} from "./chunk-HLSL32R2.js";
...
var GanttDomService = class _GanttDomService {
  constructor() {
    ...
    this.visibleRangeX = signal(
      { min: 0, max: 0 },
      ...ngDevMode ? [{ debugName: "visibleRangeX" }] : (
...
var NgxGanttBarComponent = class _NgxGanttBarComponent extends GanttItemUpper {
  constructor() {
    ...
    this.contentElementRef = viewChild(
      "content",
      ...ngDevMode ? [{ debugName: "contentElementRef" }] : (
        /* istanbul ignore next */
        []
      )
    );
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NgxGanttBarComponent, { className: "NgxGanttBarComponent", filePath: "packages/gantt/src/components/bar/bar.component.ts", lineNumber: 41 });
})();
...
//# debugId=50b8a033-6778-5344-a0a5-b86b0d0e5e97
//# sourceMappingURL=chunk-TGLAYWSK.js.map
